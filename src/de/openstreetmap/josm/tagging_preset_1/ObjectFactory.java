 ...
 * generated in the de.openstreetmap.josm.tagging_preset_1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Annotations_QNAME = new QName("http://josm.openstreetmap.de/tagging-preset-1.0", "annotations");
    private final static QName _Presets_QNAME = new QName("http://josm.openstreetmap.de/tagging-preset-1.0", "presets");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.openstreetmap.josm.tagging_preset_1
     * 
     */
    ...
    public JAXBElement<Root> createAnnotations(Root value) {
        return new JAXBElement<Root>(_Annotations_QNAME, Root.class, null, value);
    }
